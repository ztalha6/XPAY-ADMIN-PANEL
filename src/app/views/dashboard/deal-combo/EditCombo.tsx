...
import {ICreateCombo, IDealComboListing, IMultiProductInterface} from "../../../interfaces/IDealsCombo";
                                    ...
                                    <Row className={"d-flex flex-column justify-content-between align-items-start h-100 mb-4"}>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col md={4}>
                                                        <div className={"combo-fields dfields"}>
                                                            ...
                                                            <ImageUpload maxCount={1} setValue={methods.setValue} fieldName={"deal_combo_media"} value={singleDealCombo?.deal_combo_image?.mediaUrl || null}/>
                                                        </div>
                                                    </Col>
                                                    <Col md={12}>
                                            ...
                                            <Col className={"mt-auto mb-4"} md={12}>
                                                <div className={"button-section"}>
                                                    ...
                                                    <ThemeButton loader={loading} type={"submit"} className={"form-create"} text={"Save"}/>
                                                </div>
