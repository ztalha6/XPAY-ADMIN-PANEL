...
export default function Delivery() {
    ...
    const fetchData = async (params: IDatatableParams = {},data:any) => {
        setLoading(true);
        data.type =  BACKEND_CONSTANTS.ORDERS.TYPES.DELIVERY
    ...
    const columns: ColumnsType<IOrderList> = [
        ...
        },
        {
            ...
            width: '280px',
            render: (delivery_customer)=> <SkeletonTableCell loading={loading} value={delivery_customer?.name}/>,
            sorter: (a, b) => a?.delivery_customer ? a?.delivery_customer?.name?.localeCompare(b?.delivery_customer?.name || ""):0,
            sortDirections: ['descend','ascend'],
        },
        {
            title: 'Created Date',
